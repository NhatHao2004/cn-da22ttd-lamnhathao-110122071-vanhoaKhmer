                ...
                <div class="modal-body-modern">
                    ...
                    <div class="form-group-modern">
                        <label class="form-label-modern">
                            <i class="fas fa-place-of-worship"></i> Chọn Chùa <span class="text-danger">*</span>
                        </label>
                        <select name="ma_chua" class="form-control-modern" required>
                            <option value="">-- Chọn chùa --</option>
                            <?php foreach ($chuaList as $chua): ?>
                            <option value="<?= $chua['ma_chua'] ?>"><?= htmlspecialchars($chua['ten_chua']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group-modern">
