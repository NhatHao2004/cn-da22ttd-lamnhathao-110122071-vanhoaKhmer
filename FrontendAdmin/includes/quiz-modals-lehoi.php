                ...
                <div class="modal-body-modern">
                    ...
                    <div class="form-group-modern">
                        <label class="form-label-modern">
                            <i class="fas fa-calendar-check"></i> Chọn Lễ Hội <span class="text-danger">*</span>
                        </label>
                        <select name="ma_le_hoi" class="form-control-modern" required>
                            <option value="">-- Chọn lễ hội --</option>
                            <?php foreach ($leHoiList as $lh): ?>
                            <option value="<?= $lh['ma_le_hoi'] ?>"><?= htmlspecialchars($lh['ten_le_hoi']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group-modern">
